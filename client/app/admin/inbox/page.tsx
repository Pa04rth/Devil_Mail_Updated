// client/app/admin/inbox/page.tsx
"use client";
...
export default function AdminInboxPage() {
  ...
  // The admin inbox does not need a full-page loader, as the layout handles the initial loading.

  return (
    <div className="flex h-full w-full bg-black overflow-hidden">
      <div className="w-96 min-w-[384px] max-w-[500px] h-full bg-neutral-950 border-r border-neutral-800 flex flex-col">
        <div className="px-6 py-4 border-b border-neutral-800 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Mail className="w-6 h-6 text-red-500" />
            <span className="text-xl font-extrabold text-white tracking-wide">
              {searchMode ? "Search Results" : "Admin Inbox"}
            </span>
          </div>
          <button
        ...
        <div className="px-6 py-4 border-b border-neutral-800 bg-neutral-900">
          <div className="space-y-3">
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2 bg-black/50 border border-neutral-700 rounded text-white placeholder-neutral-400 focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500/20 text-sm"
          ...
          {searchMode && (
            <div className="mt-3 p-2 bg-neutral-800 border border-neutral-700 rounded text-xs text-neutral-300">
              {isSearching ? (
                <div>Searching...</div>
              ) : searchCount > 0 ? (
                <div>
              ...
              {searchQuery && (
                <div className="mt-1 text-neutral-400/70 font-mono text-xs truncate">
                  Query: {searchQuery}
                </div>
              )}
            </div>
        ...
        <div className="flex-grow overflow-y-auto bg-neutral-900 shadow-inner">
          {isLoading ? (
